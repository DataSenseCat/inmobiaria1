        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/propiedades" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Propiedades
                </Link>
              </li>
              <li>
                <Link to="/emprendimientos" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Emprendimientos
                </Link>
              </li>
              <li>
                <Link to="/tasaciones" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Tasaciones
                </Link>
              </li>
              <li>
                <Link to="/la-empresa" className="text-gray-300 hover:text-white transition-colors text-sm">
                  La Empresa
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/propiedades?operation=venta" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Venta de Propiedades
                </Link>
              </li>
              <li>
                <Link to="/propiedades?operation=alquiler" className="text-gray-300 hover:text-white transition-colors text-sm">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-gray-300 text-sm">
                  {import.meta.env.VITE_OFFICE_ADDRESS || 'Av. Belgrano 1250'}<br />
              ...
              <div className="flex items-center space-x-3">
                ...
                <a 
                  href={`tel:${import.meta.env.VITE_CONTACT_PHONE || '+54 383 456-7890'}`}
                  className="text-gray-300 hover:text-white transition-colors text-sm"
                >
                  {import.meta.env.VITE_CONTACT_PHONE || '+54 383 456-7890'}
                </a>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a 
                  href={`mailto:${import.meta.env.VITE_CONTACT_EMAIL || 'info@inmobiliariacatamarca.com'}`}
                  className="text-gray-300 hover:text-white transition-colors text-sm"
                >
                  {import.meta.env.VITE_CONTACT_EMAIL || 'info@inmobiliariacatamarca.com'}
                </a>
              </div>
            </div>
